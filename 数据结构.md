...
![](assets/数据结构/file-20260113223459271.png)
...
![](assets/数据结构/file-20260113223459272.png)
...
![](assets/数据结构/file-20260113223459273.png)
...
![](assets/数据结构/file-20260113223459273%201.png)
...
![](assets/数据结构/file-20260113223459274.png)
...
![400](assets/数据结构/file-20260113223459275.png)
...
![](assets/数据结构/file-20260113223459278.png)
...
![](assets/数据结构/file-20260113223459279.png)

## 4.2 循环队列

![](assets/数据结构/file-20260113223459294.png)
...
![](assets/数据结构/file-20260113223459281.png)

![](assets/数据结构/file-20260113223459293.png)

![](assets/数据结构/file-20260113223459292.png)
...
1. 满二叉树：结点数为：$2^h-1$
	![](assets/数据结构/file-20260113223459296.png)

2. 完全二叉树：在满二叉树的基础上，去掉最右边的若干个叶子结点
	![](assets/数据结构/file-20260113223459295.png)
...
1. **顺序存储结构：**
	...
	![](assets/数据结构/file-20260113223459296%201.png)

2. **链式存储：**
	
	**注：在含有 $n$ 个结点的二叉链表中，含有 $n+1$ 个空链域，含有 $n-1$ 个非空链域
	![](assets/数据结构/file-20260113223459307.png)
...
![](assets/数据结构/file-20260113223459312.png)
...
（1）选取最小的两个数 $2,4$ 作为子节点，将他们的和作为根节点
	![150](assets/数据结构/file-20260113223459311%201.png)

（2）将根节点 $6$ 添加进入权值序列中，并删除 $2,4$，得到 $6,7,5,9$

（3）重复 (1)(2) 操作，直至权值序列中仅剩1个
	![250](assets/数据结构/file-20260113223459312%201.png)
	![300](assets/数据结构/file-20260113223459313.png)
	![250](assets/数据结构/file-20260113223459323.png)

#### 3. 求哈弗曼编码

左孩子标为0，右孩子标为1
![250](assets/数据结构/file-20260113223459323%201.png)
...
![](assets/数据结构/file-20260113223459297.png)

**注：由树转换成二叉树，其根结点的右子树总是空的

#### 将森林转化为二叉树

![](assets/数据结构/file-20260113223459310.png)

#### 将二叉树转化为森林

![](assets/数据结构/file-20260113223459311.png)
...
![200](assets/数据结构/file-20260113223459324.png)

#### 2. 无向图 $(u,v)$  $(v,u)$

![200](assets/数据结构/file-20260113223459325.png)
...
![550](assets/数据结构/file-20260113223459325%201.png)

 **空间复杂度为 $O(V^2)$
 
#### 2. 邻接表法 

![](assets/数据结构/file-20260113223459326.png)
