...
| 排序算法   | 时间复杂度<br>（最好）  | 时间复杂度<br>（最坏）  | 时间复杂度<br>（平均）  | 辅助空间<br>复杂度   | 是否<br>稳定 |
| ------ | -------------- | -------------- | -------------- | ------------- | -------- |
| 直接插入排序 | $O(n)$         | $O(n^2)$       | $O(n^2)$       | $O(1)$        | 是        |
| 折半插入排序 | $O(n)$         | $O(n^2)$       | $O(n^2)$       | $O(1)$        | 是        |
| 希尔排序   | $O(n)$         | $O(n^2)$       | $O(n^{1.3})$   | $O(1)$        | 否        |
| 冒泡排序   | $O(n)$         | $O(n^2)$       | $O(n^2)$       | $O(1)$        | 是        |
| 快速排序   | $O(n\log_2 n)$ | $O(n^2)$       | $O(n\log_2 n)$ | $O(\log_2 n)$ | 否        |
| 简单选择排序 | $O(n^2)$       | $O(n^2)$       | $O(n^2)$       | $O(1)$        | 否        |
| 堆排序    | $O(n\log_2 n)$ | $O(n\log_2 n)$ | $O(n\log_2 n)$ | $O(1)$        | 否        |
| 归并排序   | $O(n\log_2 n)$ | $O(n\log_2 n)$ | $O(n\log_2 n)$ | $O(n)$        | 是        |
